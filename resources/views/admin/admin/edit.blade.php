    ...
    <div class="wrapper wrapper-content">
        <div class="row">
                ...
                <div class=" text-center middle-box "style="margin-top: 20px">
                    <form id="signupForm" method="post" action="{{route('admin.update',['id'=>$admin->id])}}" class="form-horizontal">
                        {{ csrf_field() }}
                        {{ method_field('put') }}
                    <div class="col-md-12">
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                <input id="name" type="text" name="name"  class="form-control" placeholder="请输入文本" value="{{$admin->name}}">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                <input id="email" type="email" name="email"  class="form-control" placeholder="请输入邮箱" required value="{{$admin->email}}">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                <input id="qq" type="text" name="qq"  class="form-control" placeholder="请输入qq号" value="{{$admin->qq}}">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                <input id="phone" type="text" name="phone"  class="form-control" placeholder="请输入常用手机号" value="{{$admin->phone}}">
                                <span class="help-block m-b-none">用于管理员联系</span>
                            </div>
                        </div>
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block m-b-none">登录后台密码(如果不修改为空)</span>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="role_id">
                                        @foreach($role_list as $n)
                                            <option value="{{$n->id}}" {{ $admin->role_id==$n->id?'selected':'' }}>{{$n->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        </div>
