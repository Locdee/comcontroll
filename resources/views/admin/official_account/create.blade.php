                ...
                <div class=" text-center middle-box "style="margin-top: 20px; max-width: 600px">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="token" type="text" name="token"  class="form-control" placeholder="请输入Appscret">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="aes_key" type="text" name="aes_key"  class="form-control" placeholder="请输入Appscret">
