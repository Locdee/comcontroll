    ...
    <div class="wrapper wrapper-content">
        <div class="row">
                ...
                <div class=" text-center middle-box "style="margin-top: 20px">
                    <form id="signupForm" method="post" action="{{route('prize.store')}}" class="form-horizontal">
                        {{ csrf_field() }}
                    <div class="col-md-12">
                        <div class="form-group" >
                            <label class="col-sm-3 control-label">奖品名称：</label>
                            <div class="col-sm-9">
                                <input id="name" type="text" name="prizename"  class="form-control" placeholder="请输入文本">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                <input id="name" type="number" min="0"  name="count"  class="form-control" placeholder="请输入文本">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-9">
                                <input id="name" type="number" min="0"  name="weight"  class="form-control" placeholder="请输入文本">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">相关专题：</label>
                            <div class="col-sm-9">
                                <select class="form-control" name="activity_id">
                                    @foreach($activity_list as $n)
                                        <option value="{{$n->id}}" {{ $ac_id==$n->id?'selected':'' }}>{{$n->activityname}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
